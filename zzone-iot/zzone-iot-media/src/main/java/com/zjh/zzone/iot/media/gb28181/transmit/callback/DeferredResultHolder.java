...
import com.ylg.iot.media.bo.DeferredResultEx;
...
public class DeferredResultHolder {
	// 设备状态获取请求回调标识
	public static final String CALLBACK_CMD_DEVICE_STATUS = "CALLBACK_DEVICESTATUS";
	// 设备信息获取请求回调标识
	public static final String CALLBACK_CMD_DEVICE_INFO = "CALLBACK_DEVICEINFO";
	// 设备控制请求回调标识
	public static final String CALLBACK_CMD_DEVICE_CONTROL = "CALLBACK_DEVICECONTROL";
	// 设备配置请求回调标识
	public static final String CALLBACK_CMD_DEVICE_CONFIG = "CALLBACK_DEVICECONFIG";
	// 设备配置下载请求回调标识
	public static final String CALLBACK_CMD_CONFIG_DOWNLOAD = "CALLBACK_CONFIGDOWNLOAD";
	...
	public static final String CALLBACK_CMD_PRESET_QUERY = "CALLBACK_PRESETQUERY";

...
public class UserSetting {
     ...
     * 意义：将平台服务ip作为流媒体服务ip，所以要求两个服务部署在同一服务器
     */
     ...
     */
    private Boolean useSipSourceIpAsRemoteAddress = Boolean.FALSE;
     ...
     * 默认水平速度 TODO
     */
//    @Value("${media.ptz.horizon-speed}")
    private int ptzHorizonSpeed;
    /**
     * 默认垂直速度
     */
//    @Value("${media.ptz.vertical-speed}")
    private int ptzVerticalSpeed;
    /**
     * 默认缩放速度
     */
//    @Value("${media.ptz.zoom-speed}")
    private int ptzZoomSpeed;
    /**
     * 默认云台操作持续时间（秒）
     */
//    @Value("${media.ptz.action-duration-seconds}")
    private long ptzActionDurationSeconds;
    /**
     * 默认录像下载速度
     */
//    @Value("${media.record.download-speed}")
    private String recordDownloadSpeed;

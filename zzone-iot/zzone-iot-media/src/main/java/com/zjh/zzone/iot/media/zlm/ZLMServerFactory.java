...
import com.ylg.iot.media.gb28181.common.CommonCallback;
...
public class ZLMServerFactory {
     ...
     * @return 观看人数
     */
    public Integer getReaderCount(MediaServer mediaServerItem, String app, String streamId, String schema) {
        JSONObject mediaInfo = zlmRestFulUtils.getMediaList(mediaServerItem, app, streamId, schema, null);
        if (mediaInfo != null || (mediaInfo.getInteger("code") == 0)) {
            return mediaInfo.getJSONArray("data").getJSONObject(0).getInteger("readerCount");
        }
